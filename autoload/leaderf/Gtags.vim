...
function! leaderf#Gtags#Maps()
    ...
    nnoremap <buffer> <silent> <F5>          :exec g:Lf_py "gtagsExplManager.refresh()"<CR>
...
function! leaderf#Gtags#generateGtags()
    call leaderf#LfPy("gtagsExplManager.generateGtags()")
endfunction
